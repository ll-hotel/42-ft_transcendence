...
export class MatchInfo {
	...
	toHTML(): HTMLElement {
		...
		h.innerHTML = `
			...
			<button name="go-to" title="Send friend request" class="w-full text-sm sm:text-base ml-auto p-1 sm:p-2 border border-white bg-black hover:bg-neutral-600 text-white rounded-md sm:rounded-xl">Player profile</button>
		`;

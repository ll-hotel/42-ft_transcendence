...
// 		this.paddle_p1 = new PongPaddle({x: 0, y: this.canvas.height / 2});
// 		this.paddle_p2 = new PongPaddle({x: this.canvas.width, y: this.canvas.height / 2});
...
//
// 	constructor(canvas: HTMLCanvasElement, score: Score, paddle_p1: PongPaddle, paddle_p2: PongPaddle)
// 	{
